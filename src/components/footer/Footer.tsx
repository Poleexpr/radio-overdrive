        ...
        <div className={styles.container}>
          <div className={styles.subcontainer_first}>
            ...
            <div className={styles.nets_wrapper}>
              ...
              <a href='https://www.instagram.com/radio_overdrive/' target='_blank'>
                <IconLogoInstagram className={styles.net_logo} />
              </a>
            </div>
          </div>
          <div className={styles.subcontainer_second}>
            <a href='mailto:radio@russiandino.ru' target='_blank' className={styles.mail_link}>
            ...
            <div className={styles.rd_wrapper}>
              <a href='https://www.russiandino.ru' target='_blank' className={styles.rd}>
                <IconLogoRD />
